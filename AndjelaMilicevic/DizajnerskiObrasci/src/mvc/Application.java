...
public class Application {
	public static void main(String[] args) {
		...
		/*
		 * String stringRectModify =
		 * "Deleted Line:SP(370,296) EP(381,286) BC(255,51,51), selected"; String[]
		 * splitsRectModify = stringRectModify.split("[, =():]"); for (int i = 0; i <
		 * splitsRectModify.length; i++) {
