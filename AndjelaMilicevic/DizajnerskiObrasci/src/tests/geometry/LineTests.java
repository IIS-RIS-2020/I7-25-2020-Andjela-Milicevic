...
public class LineTests {
	...
	public void testToString() {
		assertEquals(
	"Line:StartPoint(" + line.getStartPoint().getXcoordinate() + "," + line.getStartPoint().getYcoordinate()
	+ ") EndPoint(" + line.getEndPoint().getXcoordinate() + "," + line.getEndPoint().getYcoordinate() + ") "
	+ "BorderColor(" + borderColor.getRGB() + "), " + line.isSelected(), line.toString());
	}
